...
```{r ans23}
course[[2]]$teacher <-  "紀學檜" 
course_update2 <- str(course)
# course_update2
```
...
```{r ans32}
Pikachu_stats <- as.integer( Pikachu[[1]][[4]])
Pikachu_stats
# Pikachu_stats
```
...
Jigglypuff <- list(Gamemaster[[1]][[46]])
Jigglypuff
# Jigglypuff
```
...
Gamemaster[[1]][[731]] <- 
  list(
    ...
    legacyMoves = c("PRESENT","SURF","THUNDER"),
    defaultIVs = list(
